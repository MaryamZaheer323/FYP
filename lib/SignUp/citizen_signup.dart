...
// lib/screens/Citizen/citizen_signup.dart
import 'dart:io';
...
final TextEditingController _addressController =
    TextEditingController(text: "Rawalpindi, Pakistan");

  final Map<String, File?> _files = {'profilePhoto': null, 'scannedCNIC': null};
  ...
  Future<void> _pickFile(String fileType) async {
    try {
      ...
      if (file != null) {
        ...
        _showMessage('Success', 'File selected successfully ✅');
      }
    } catch (e) {
      _showMessage('Error', 'Failed to pick file: $e');
    }
...
Future<void> _register() async {
  if (_formKey.currentState!.validate()) {
    ...
    try {
      ...
      await _firestoreService.registerCitizen(userData, _files);

      print("✅ Registration success from Firestore service");
      ...
      print("⏳ Waiting for navigation delay (2 seconds)");
      ...
      print("🏁 Registration process finished (loading false)");
    }
  } else {
