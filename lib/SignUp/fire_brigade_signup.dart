...
class FireBrigadeSignupScreen extends StatefulWidget {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildTextField(
                        ...
                        label: 'Official Email (@firebrigade.gov.pk)',
                        icon: Icons.email,
                        ...
                        validator: (value) {
                          ...
                          if (!value.endsWith('@firebrigade.gov.pk')) {
                            return 'Email must end with @firebrigade.gov.pk';
                          }
                          return null;
                        },
                      ),
                      ...
                      const Text(
                        'Fire Brigade Department Information',
                        style: TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                          color: Colors.white,
                      ...
                      _buildTextField(
                        ...
                        label: 'Fire Brigade Department/Unit',
                      ...
                      _buildTextField(
                        ...
                        label: 'Fire Station/Posting Location',
                      ...
                      _buildTextField(
                        ...
                        label: 'Joining Date in Fire Brigade',
