                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildTextField(
                        ...
                        label: 'Official Email (@punjabpolice.gov.pk)',
                        icon: Icons.email,
                        ...
                        validator: (value) {
                          ...
                          if (!value.endsWith('@punjabpolice.gov.pk')) {
                            return 'Email must end with @punjabpolice.gov.pk';
                          }
                          return null;
                        },
                      ),
                      ...
                      _buildTextField(
                        ...
                        label: 'Police Force Department/Unit',
                        icon: Icons.business,
                        isRequired: true,
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                      ...
                      _buildTextField(
                        ...
                        label: 'Police Station/Posting Location',
                      ...
                      _buildTextField(
                        ...
                        label: 'Joining Date in Police Service',
