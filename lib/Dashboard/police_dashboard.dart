// import 'package:disaster_watch/reports/department_reports_screen.dart';
...
//                       context,
//                       MaterialPageRoute(
//                         builder: (context) => const DepartmentReportsScreen(
//                           department: 'Police',
//                           departmentColor: '0xFF2196F3',
//                           departmentIcon: Icons.local_police,
...
//                     const SizedBox(height: 10),
//                     const Text(
//                       'Live incident locations will appear here',
...
//       MaterialPageRoute(
//         builder: (context) =>
//             EditProfileScreen(userData: userData, userRole: 'Police'),
//       ),
//     );
...
//                   Icons.military_tech,
//                   'Rank',
//                   userData['rank'] ?? 'Not provided',
//                 ),
//                 _buildProfileItem(
//                   Icons.confirmation_number,
//                   'Badge Number',
//                   userData['badgeNumber'] ?? 'Not provided',
//                 ),
//                 _buildProfileItem(
//                   Icons.assignment_ind,
//                   'Service ID',
//                   userData['serviceId'] ?? 'Not provided',
//                 ),
//                 _buildProfileItem(
...
//             MaterialPageRoute(
//               builder: (context) =>
//                   HelpSupportScreen(userData: userData, userRole: 'Police'),
//             ),
//           );
//         } else if (isPrivacy) {
//           Navigator.push(
...
//             MaterialPageRoute(
//               builder: (context) =>
//                   PrivacyPolicyScreen(userData: userData, userRole: 'Police'),
//             ),
//           );
//         } else {
...
class PoliceDepartmentDashboardScreen extends StatefulWidget {
  final String department;
  final String departmentColor;
  final IconData departmentIcon;
  final String collectionName;

  const PoliceDepartmentDashboardScreen({
    super.key,
  ...
  @override
  State<PoliceDepartmentDashboardScreen> createState() => _PoliceDepartmentDashboardScreenState();
}

class _PoliceDepartmentDashboardScreenState extends State<PoliceDepartmentDashboardScreen>
