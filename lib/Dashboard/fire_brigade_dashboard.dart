...
// class FireBrigadeDashboard extends StatefulWidget {
//   final Map<String, dynamic> userData;

//   const FireBrigadeDashboard({super.key, required this.userData});

//   @override
//   State<FireBrigadeDashboard> createState() => _FireBrigadeDashboardState();
// }

// class _FireBrigadeDashboardState extends State<FireBrigadeDashboard>
...
//         children: [
//           _FireIncidentsTab(userData: userData),
//           _FireAllIncidentsTab(),
//           _FireMapTab(),
//           _FireProfileTab(userData: userData, onUpdateUserData: _updateUserData),
//         ],
//       ),
//       bottomNavigationBar: _FireCurvedNavigationBar(
...
// class _FireCurvedNavigationBar extends StatelessWidget {
...
//   const _FireCurvedNavigationBar({
...
//               width: 50,
//               height: 50,
//               decoration: BoxDecoration(color: buttonBackgroundColor, shape: BoxShape.circle),
//               child: items[index],
//             ),
//           );
//         }),
...
// class _FireIncidentsTab extends StatelessWidget {
//   final Map<String, dynamic> userData;

//   const _FireIncidentsTab({required this.userData});

//   void _showMessage(BuildContext context, String message) {
//     ScaffoldMessenger.of(context).showSnackBar(
//       SnackBar(content: Text(message), backgroundColor: Colors.deepOrange, duration: const Duration(seconds: 2)),
//     );
//   }
...
//         gradient: LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Colors.black, Color(0xFF0A0E21)]),
//       ),
//       child: Column(
//         children: [
//           _FireGlassContainer(
...
//                   children: [
//                     const Text('Fire Brigade Dashboard', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white)),
//                     const SizedBox(height: 5),
//                     Text('Welcome, ${userData['name']?.split(' ').first ?? 'Officer'}', style: const TextStyle(fontSize: 14, color: Colors.white70)),
//                   ],
//                 ),
//                 GestureDetector(
//                   onTap: () => _showMessage(context, 'Notifications clicked'),
//                   child: const CircleAvatar(radius: 25, backgroundColor: Colors.deepOrange, child: Icon(Icons.notifications, color: Colors.white)),
//                 ),
//               ],
//             ),
//           ),
...
//                     onTap: () => _showMessage(context, 'Pending fire incidents clicked'),
//                     child: _FireGlassContainer(
...
//                 Expanded(
//                   child: GestureDetector(
//                     onTap: () => _showMessage(context, 'Active fire incidents clicked'),
//                     child: _FireGlassContainer(
//                       padding: const EdgeInsets.all(5),
//                       child: Column(
//                         children: const [
//                           Icon(Icons.play_circle_fill, color: Colors.deepOrange, size: 30),
//                           SizedBox(height: 8),
//                           Text('Active', style: TextStyle(fontSize: 12, color: Colors.white70)),
//                           SizedBox(height: 5),
//                           Text('3', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.deepOrange)),
//                         ],
//                       ),
//                     ),
//                   ),
...
//                 Expanded(
//                   child: GestureDetector(
//                     onTap: () => _showMessage(context, 'Completed fire incidents clicked'),
//                     child: _FireGlassContainer(
//                       padding: const EdgeInsets.all(5),
//                       child: Column(
//                         children: const [
...
//                           SizedBox(height: 5),
//                           Text('18', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.green)),
//                         ],
//                       ),
//                     ),
//                   ),
...
//               mainAxisAlignment: MainAxisAlignment.spaceBetween,
//               children: [
//                 Text('Recent Fire Incidents', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
//                 Text('View All', style: TextStyle(fontSize: 14, color: Colors.deepOrange)),
//               ],
//             ),
//           ),
//           Expanded(
...
//               children: [
//                 _buildIncidentCard(context, type: 'Building Fire', location: '📍 Mall Road, Lahore', time: '10:30 AM', status: 'Pending', statusColor: Colors.orange, statusIcon: Icons.pending, priority: 'High'),
//                 _buildIncidentCard(context, type: 'Factory Fire', location: '📍 Industrial Area, Karachi', time: '09:45 AM', status: 'Active', statusColor: Colors.deepOrange, statusIcon: Icons.play_circle_fill, priority: 'Critical'),
//                 _buildIncidentCard(context, type: 'Forest Fire', location: '📍 Murree Hills', time: '08:15 AM', status: 'Completed', statusColor: Colors.green, statusIcon: Icons.check_circle, priority: 'Medium'),
//               ],
//             ),
//           ),
//         ],
...
//     return GestureDetector(
//       onTap: () => _showMessage(context, '$type incident clicked'),
//       child: _FireGlassContainer(
...
//                 const Spacer(),
//                 Text('Priority: $priority', style: TextStyle(color: priority == 'Critical' ? Colors.red : priority == 'High' ? Colors.deepOrange : Colors.orange, fontWeight: FontWeight.bold)),
//               ],
//             ),
//           ],
//         ),
...
// class _FireAllIncidentsTab extends StatelessWidget {
//   const _FireAllIncidentsTab();
...
//           _FireGlassContainer(
//             margin: const EdgeInsets.only(top: 40, left: 20, right: 20),
//             child: const Text('All Fire Incidents', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.white)),
//           ),
...
//               children: [
//                 _buildIncidentCard(context, type: 'Building Fire', location: '📍 Mall Road, Lahore', time: '10:30 AM', status: 'Pending', statusColor: Colors.orange, priority: 'High'),
//                 _buildIncidentCard(context, type: 'Factory Fire', location: '📍 Industrial Area, Karachi', time: '09:45 AM', status: 'Active', statusColor: Colors.deepOrange, priority: 'Critical'),
//                 _buildIncidentCard(context, type: 'Forest Fire', location: '📍 Murree Hills', time: '08:15 AM', status: 'Completed', statusColor: Colors.green, priority: 'Medium'),
//               ],
//             ),
//           ),
//         ],
...
//     return GestureDetector(
//       onTap: () => _showMessage(context, '$type incident details'),
//       child: _FireGlassContainer(
//         margin: const EdgeInsets.only(bottom: 15),
//         child: Column(
//           crossAxisAlignment: CrossAxisAlignment.start,
...
// class _FireMapTab extends StatelessWidget {
//   const _FireMapTab();
...
//           _FireGlassContainer(
//             margin: const EdgeInsets.only(top: 40, left: 20, right: 20),
//             child: const Text('Live Fire Incident Map', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.white)),
//           ),
//           Expanded(
//             child: Center(
//               child: _FireGlassContainer(
...
//                     const SizedBox(height: 20),
//                     const Text('Fire Station Map View', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),
//                     const SizedBox(height: 10),
//                     const Text('Live fire incident locations will appear here', style: TextStyle(fontSize: 14, color: Colors.white70), textAlign: TextAlign.center),
//                     const SizedBox(height: 20),
//                     ElevatedButton(
//                       onPressed: () => _showMessage(context, 'Refresh map clicked'),
...
// class _FireProfileTab extends StatelessWidget {
//   final Map<String, dynamic> userData;
//   final Function(Map<String, dynamic>) onUpdateUserData;

//   const _FireProfileTab({required this.userData, required this.onUpdateUserData});
...
//       context,
//       MaterialPageRoute(builder: (context) => EditProfileScreen(userData: userData, userRole: 'Fire Brigade')),
//     );
...
//                   Stack(
//                     children: [
//                       const CircleAvatar(radius: 50, backgroundColor: Colors.deepOrange, child: Icon(Icons.local_fire_department, size: 40, color: Colors.white)),
//                       Positioned(
//                         bottom: 0,
//                         right: 0,
//                         child: Container(
...
//                   ),
//                   const SizedBox(height: 20),
//                   Text(userData['name'] ?? 'Sarah Khan', style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.white)),
//                   const SizedBox(height: 5),
//                   Container(
//                     margin: const EdgeInsets.only(top: 5),
//                     padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 4),
//                     decoration: BoxDecoration(color: Colors.deepOrange.withOpacity(0.2), borderRadius: BorderRadius.circular(20)),
//                     child: Text(userData['role'] ?? 'FIRE OFFICER', style: const TextStyle(color: Colors.deepOrange, fontWeight: FontWeight.bold, fontSize: 12)),
//                   ),
//                   const SizedBox(height: 10),
//                   const Text('Tap to edit profile', style: TextStyle(fontSize: 12, color: Colors.white54)),
//                 ],
//               ),
//             ),
//           ),
...
//                     IconButton(icon: const Icon(Icons.edit, color: Colors.deepOrange, size: 20), onPressed: () => _editProfile(context)),
//                   ],
//                 ),
//                 const SizedBox(height: 15),
...
//                 SizedBox(width: 8),
//                 Text('Account created: 01/06/2024', style: TextStyle(fontSize: 12, color: Colors.white70)),
//               ],
//             ),
//           ),
//         ],
...
//       onTap: () {
//         if (isSettings) {
//           Navigator.push(context, MaterialPageRoute(builder: (context) => SettingsScreen(userData: userData)));
//         } else if (isHelp) {
//           Navigator.push(context, MaterialPageRoute(builder: (context) => HelpSupportScreen(userData: userData, userRole: 'Fire Brigade')));
//         } else if (isPrivacy) {
//           Navigator.push(context, MaterialPageRoute(builder: (context) => PrivacyPolicyScreen(userData: userData, userRole: 'Fire Brigade')));
//         } else {
...
// class _FireGlassContainer extends StatelessWidget {
//   final Widget child;
//   final EdgeInsetsGeometry? margin;
//   final EdgeInsetsGeometry? padding;

//   const _FireGlassContainer({required this.child, this.margin, this.padding});
...
class FireBrigadeDepartmentDashboardScreen extends StatefulWidget {
  final String department;
  final String departmentColor;
  final IconData departmentIcon;
  final String collectionName;

  const FireBrigadeDepartmentDashboardScreen({
    super.key,
  ...
  @override
  State<FireBrigadeDepartmentDashboardScreen> createState() => _FireBrigadeDepartmentDashboardScreenState();
}

class _FireBrigadeDepartmentDashboardScreenState extends State<FireBrigadeDepartmentDashboardScreen>
