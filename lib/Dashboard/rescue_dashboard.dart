...
class RescueDepartmentDashboardScreen extends StatefulWidget {
  final String department;
  final String departmentColor;
  final IconData departmentIcon;
  final String collectionName;

  const RescueDepartmentDashboardScreen({
    super.key,
  ...
  @override
  State<RescueDepartmentDashboardScreen> createState() => _RescueDepartmentDashboardScreenState();
}

class _RescueDepartmentDashboardScreenState extends State<RescueDepartmentDashboardScreen>
